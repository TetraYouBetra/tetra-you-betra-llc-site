...
export default function TestimonialTree({
  tree,
  selectedId,
  expanded,
  onSelect,
...
function TreeNodeRow({
  ...
  const isSelected =
    selectedId === node.id || selectedId === node.testimonialId;
  ...
  const handleClick = () => {
    ...
    onSelect(node.testimonialId ?? node.id);
  };
